...
turtles-own [color-initial ai bi ci di x y s g g-old h h-old eta]
...
;; Robust asynchronous broadcast Newton-Raphson algorithm
to go
  ...
  ask one-of turtles [
    ...
    ask out-link-neighbors [
      ...
      set y-sum y-sum + ratio * (y + g - g-old)
      set s-sum s-sum + ratio * (s + h - h-old)
    ]
