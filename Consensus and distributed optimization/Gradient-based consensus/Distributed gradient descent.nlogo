...
turtles-own [color-initial ai bi ci di alfa x]
...
to go
  ...
  ask turtles [
    ...
    let temp-consensus 0
    let ratio 1 / (count my-out-links + 1)

    ask out-link-neighbors [

      set temp-consensus temp-consensus + ratio * x

    ]

    set x ratio * x + temp-consensus - alfa * cost-fun-der ai bi ci di x
